...
module.exports = class Staff extends CommandInterface {
    ...
    constructor(client) {
        ...
        this.name = "dajminus",
            ...
            this.aliases = ["addminus"],
            this.description = "Dodajte minus staff korisniku/ci."
    };
    ...
    async execute(message, args) {
        ...
        if (user.id === this.client.user.id)
            return this.client.util.embed(
                ...
                message.author,
                "",
                `${this.client.emoji.no} Ne možete dati minus meni.`,
                "Error"
            );
        ...
        if (user.id === message.author.id)
            return this.client.util.embed(
                ...
                message.author,
                "",
                `${this.client.emoji.no} Ne možete dati minus sami sebi.`,
                "Error"
            );
        ...
        if (!data) {
            new this.client.database.staff({
                ...
                Plus: 0,
                Minus: 1,
                History: [`> **[${new Date().toLocaleString()}]** Dodan **minus** od strane korisnika/ce **${message.author.tag}**.`],
                DutyStatus: false,
                DutyStart: 0,
                DutyTime: 0,
                DutyToday: 0,
            ...
            return this.client.util.embed(
                ...
                message.author,
                "",
                `${this.client.emoji.yes} Uspješno ste dodali **minus** staff korisniku/ci.`,
                "Success"
            );
        } else {
            data.Minus += 1;
            data.History.push(`> **[${new Date().toLocaleString()}]** Dodan **minus** od strane korisnika/ce **${message.author.tag}**.`);
            data.save();
