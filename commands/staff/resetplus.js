...
module.exports = class Staff extends CommandInterface {
    ...
    constructor(client) {
        ...
        this.name = "resetplus",
            ...
            this.aliases = ["deleteplus"],
            this.description = "Resetajte pluseve staff korisniku/ci."
    };
    ...
    async execute(message, args) {
        ...
        if (user.id === this.client.user.id)
            return this.client.util.embed(
                ...
                message.author,
                "",
                `${this.client.emoji.no} Ne možete resetati pluseve meni.`,
                "Error"
            );
        ...
        if (user.id === message.author.id)
            return this.client.util.embed(
                ...
                message.author,
                "",
                `${this.client.emoji.no} Ne možete resetate pluseve sami sebi.`,
                "Error"
            );
        ...
        if (!data) {
            return this.client.util.embed(
                ...
                message.author,
                "",
                `${this.client.emoji.no} Korisnik/ca nema pluseve.`,
                "Error"
            )
        } else if (data) {
            if (data.Plus < 1)
            ...
            data.Plus = 0;
            data.History.push(`> **[${new Date().toLocaleString()}]** Resetani **plusevi** od strane korisnika/ce **${message.author.tag}**.`);
            data.save();
            ...
            return this.client.util.embed(
                ...
                message.author,
                "",
                `${this.client.emoji.yes} Uspješno ste resetali **pluseve** staff korisniku/ci.`,
                "Success"
            );
        }
    }
